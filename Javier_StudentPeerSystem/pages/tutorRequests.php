...
<div class="welcome-section">
    ...
    <p>Manage your incoming and pending session requests below. Your profile actions are available in the navigation
        bar.</p>
    <?php if ($message): ?>
                    ...
                    <div class="action-buttons">
                        <form method="POST" style="display: inline-block;">
                            ...
                            <input type="hidden" name="enrollmentID"
                                value="<?php echo htmlspecialchars($request['enrollmentID']); ?>">
